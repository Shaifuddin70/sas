...
$query = "SELECT student.name,student.cid,student.sid, attendance.attendance_date,attendance.attendance_value   
          FROM student
...
<table class="table ">
    ...
    if ($total != 0) {
        while ($result = mysqli_fetch_assoc($data)) {
            $cid = $result['cid']; // Access the 'cid' value from the $fetch array
            $sid = $result['sid']; // Access the 'sid' value from the $fetch array
