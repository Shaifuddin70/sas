...
INSERT INTO `attendance` (`id`, `student_id`, `attendance_date`, `attendance_value`) VALUES
(60, 6, '2023-10-23', 1),
(61, 7, '2023-10-23', 0),
(62, 10, '2023-10-23', 1),
(63, 5, '2023-10-23', 1);
...
INSERT INTO `employee` (`id`, `name`, `department_id`, `cid`, `sid`, `number`, `email`, `password`, `role`) VALUES
(1, 'Shaifuddin', 14, 1, 1, 1635485720, 'shaifuddin70@gmail.com', '$2y$10$H/kT9mE.DPWuMGhWuYcTZ.PVEJsvhCsSiFBRaxaZ4KDJwyW5EK0pa', 1),
(32, 'Rohim', 15, 1, 1, 2147483647, 'rohim@gmail.com', '$2y$10$lIEh34scWukFnZUJvuNO6eOTBC2M3DZIY1oE87SUo8wdNx8XF7BeS', 2),
(34, 'Karim', 14, 2, 2, 13654855, 'karim@gmail.com', '$2y$10$SzwaUDkCpdYybzuIQrg6/.3wrFG/SltqMBtZPMEbz3mlFuFklSDB2', 2),
(35, 'Scott T.', 14, 1, 1, 2147483647, 'dardentimothy3@gmail.com', '$2y$10$5fegqJtIce/1wmNTfVa3r.GSmLuBps5ZklVF3s9X8JtrLvz8lWKS.', 2),
(36, 'Rokib COOKED', 15, 2, 2, 1538347152, 'rokib2064@gmail.com', '$2y$10$jq0s4aco0DmbTuiMK0LUxuBYocJcLnbn8ipICYELBU5OXvZziyFtS', 2);
...
INSERT INTO `student` (`id`, `roll`, `name`, `cid`, `sid`) VALUES
(5, 19103188, 'Rokib', 1, 1),
(6, 2, 'tonyy', 1, 1),
(7, 3, 'alvi', 1, 1),
(8, 1, 'sara', 2, 1),
(9, 4, 'andy', 2, 2),
...
--
ALTER TABLE `student`
  ADD CONSTRAINT `class` FOREIGN KEY (`cid`) REFERENCES `class` (`cid`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `section` FOREIGN KEY (`sid`) REFERENCES `section` (`sid`);
COMMIT;
