<?php include 'nav.php';
$id = $_SESSION['eid'];
$query = mysqli_query($conn, "SELECT employee.name,employee.email,employee.role,employee.number,employee.department_id FROM employee JOIN department on department.id=employee.department_id WHERE employee.id='$id'");
